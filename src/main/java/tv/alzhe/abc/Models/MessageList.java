...
public class MessageList {
	...
	public MessageList() {
		messages.add(new Message("&7&oFirst message !"));
		messages.add(new Message("&7&oSecond message in the list with formatters!"));
		messages.add(new Message("&7&oThird message in the list with formatters and an\n&7&oanother new line!"));
	}
